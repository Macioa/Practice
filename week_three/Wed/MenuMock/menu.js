...
var mymenu = new menu("tim");
mymenu.attach(document.getElementsByTagName('body')[0]);
mymenu.playButton.style.visibility="hidden";
var mymenu = new menu("bob");
mymenu.attach(document.getElementsByTagName('body')[0]);